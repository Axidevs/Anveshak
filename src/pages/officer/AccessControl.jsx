 ...
 *
 * PBAC permissions are defined here as application policy configuration.
 * They are not demo/mock case data.
 */
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="flex items-start gap-4 p-4 mb-6 bg-navy/5 border border-navy/20 rounded-xl">
          ...
          <div>
            ...
            <h3 className="text-sm font-bold text-navy">
              Post-Based Access Control System (PBAC)
            </h3>

            <p className="text-sm text-gray-700 mt-1 leading-relaxed">

              Nyaya Setu employs a strict Post-Based Access Control mechanism.
              All permissions are derived from your current designation and
              jurisdictional posting — not personal identity. Upon transfer or
              reassignment, access is automatically revoked from the previous
            ...
            <thead>
              ...
              <tr className="bg-gray-50 text-xs text-gray-600 font-semibold">
                ...
                {columns.map(col => (
                  ...
                  <th
                    key={col.key}
                    className="p-3 border-b border-gray-200 border-r border-gray-200 text-center whitespace-nowrap"
                  >
                    {col.label}
                  </th>
        ...
        <p className="text-xs text-gray-400 mt-4">
          ...
          * Cross-agency access requires a formal data-sharing request approved
          by the Nodal Officer. All access provisioning events are logged in
