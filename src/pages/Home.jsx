...
export default function Landing() {
  ...
  const testimonials = [
    { name: 'Jitin Prasada', role: 'Minister of State for Electronics & Information Technology', image: '/voices/jitin-prasada.jpeg' },
    { name: 'Justice Surya Kant', role: 'Chief Justice of India', image: '/voices/surya-kant.jpeg' },
    { name: 'Kiran Bedi', role: 'Former IPS Officer', image: '/voices/kiran-bedi.jpeg' },
  ];
          ...
          <div className="relative">
            <div className="glass-card p-3 sm:p-5 text-center">
              <img
                ...
                alt={`Voice of Change: ${testimonials[testimonialIdx].name}`}
