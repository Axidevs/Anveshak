...
export const HeroGateway: React.FC<HeroGatewayProps> = ({
  ...
  const [revealedHindiCount, setRevealedHindiCount] = useState<number>(0);
            ...
            {isAuthenticating ? (
              <>
                ...
                <span className="tracking-wide text-xs sm:text-sm">
                  {language === 'hi'
                    ? 'संप्रभु हैंडशेक स्थापित हो रहा है...'
              ...
              <>
                ...
                <span className="tracking-wide">
                  {language === 'hi'
                    ? 'ऑनबोर्डिंग प्रक्रिया प्रारंभ करें'
                    : 'Enter National Justice Network'}
                </span>
