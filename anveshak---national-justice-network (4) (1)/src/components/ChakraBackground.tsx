...
export const ChakraBackground: React.FC = () => {
  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none select-none">
      ...
      <div
        className="absolute top-1/2 left-1/2 w-[min(520px,calc(100vh-140px),calc(100vw-48px))] h-[min(520px,calc(100vh-140px),calc(100vw-48px))] opacity-[0.15] pointer-events-none animate-spin-chakra flex items-center justify-center"
        aria-hidden="true"
      >
        <svg
